                        ...
                        <>
                            ...
                            <Modal
                                ...
                                <Modal.Body>
                                    ...
                                    <h3>Detail Transaksi : {TransaksiId}</h3>
                                    ...
                                    <Table striped bordered hover responsive cellspacing="0" cellpadding="10" style={{ fontSize:13, borderColor:'white', width:'100%' }}>
                                        <Thead>
                                            <Tr style={{color:"#004372", borderColor:'white', textAlign:'left'}}>
                                                ...
                                                <Th className="tabelHeader"><LabelTH>Harga</LabelTH></Th>
                                            ...
                                            ListTransaksiJualDetail.length > 0 ? ListTransaksiJualDetail.map((item,index) => {
                                                return <Tr style={{
                                                    ...
                                                    textAlign:'left'
                                                        ...
                                                        <td style={{ color:'#546E7A', paddingTop:20, paddingBottom:20 }} onMouseOut={handleMouseOut}>{'Rp. ' + FormatNumberBy3(item.Total)}</td>
                                                    </Tr>;
