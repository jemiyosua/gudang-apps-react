...
const StokProduct = () => {
	...
	const [TotalStokProduk, setTotalStokProduk] = useState(0)
    ...
    const getListProdukStok = (ProdukId) => {
		...
		.then((data) => {
			...
			if (data.ErrorCode === "0") {
				setListProdukStok(data.Result.Result)
				setTotalStokProduk(data.Result.TotalStock)
                setTotalData(data.TotalRecords)
                setTotalPages(data.TotalPage)
			} else {
				if (data.ErrorCode === "2") {
    ...
    return (
		<div className="main-page" style={{ backgroundColor:'#F6FBFF' }}>
            {/* <div style={{ backgroundColor:'#F6FBFF', width:'100%' }} >
                    ...
                    <div style={{ backgroundColor:'#FFFFFF', height:'auto', width:'100%', borderTopLeftRadius:25, borderBottomLeftRadius:25, borderBottomRightRadius:25, borderTopRightRadius:25, padding:20 }}>
                        ...
                        <Modal
                            ...
                            <Modal.Body>
                                ...
                                <h3>Stok Product : {NamaProdukStok}</h3>
                                <div style={{  fontWeight:'bold'  }}>Total Stock : {TotalStokProduk}</div>
                                        ...
                                        ListProdukStok.length > 0 ? ListProdukStok.map((item,index) => {
                                            return <Tr style={{
                                                ...
                                                textAlign:'left'
                                                    ...
                                                    <td style={{ color:'#546E7A', paddingTop:20, paddingBottom:20 }} onMouseOut={handleMouseOut}>{item.TanggalExpiredString}</td>
                                                </Tr>;
