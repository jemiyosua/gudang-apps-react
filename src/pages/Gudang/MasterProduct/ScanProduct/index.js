...
const ScanProduct = () => {
    ...
    const simpanData = () => {
        ...
        if (ListBarcodeScan.length < 1) {
            errorMessage += "Please scan min.1 Product"
        }
		...
		.then((data) => {
			...
			if (data.ErrorCode === "0") {
                setCookie("PageReturn", "ScanProduct")
            ...
            <div style={{ backgroundColor:'#FFFFFF', height:'auto', width:'100%', borderBottomLeftRadius:25, borderBottomRightRadius:25 }}>
                ...
                <div style={{ display:'flex', justifyContent:'flex-end', alignItems:'center' }}>
                    ...
                    <div>
                        ...
                        <div style={{ padding:10, height:'auto', borderTopLeftRadius:15, borderTopRightRadius:15, borderBottomLeftRadius:15, borderBottomRightRadius:15, cursor:'pointer', backgroundColor:'#004175' }} onClick={() => simpanData()}>
                            <div style={{ fontWeight:'bold', fontSize:13, color:'#FFFFFF' }}>SAVE</div>
                        </div>
                    </div>
                    }
                </div>
                ...
                <Thead>
                        <Tr style={{ color:"#004372", borderColor:'white', textAlign:'left' }}>
                            ...
                            <Th className="tabelHeader"><LabelTH>Category</LabelTH></Th>
                            <Th className="tabelHeader"><LabelTH>Selling Price (Rp)</LabelTH></Th>
                            <Th className="tabelHeader"><LabelTH>Buying Price (Rp)</LabelTH></Th>
                            {/* <Th className="tabelHeader"><LabelTH>Unit</LabelTH></Th> */}
                            <Th className="tabelHeader"><LabelTH>Quantity</LabelTH></Th>
                            {/* <Th className="tabelHeader"><LabelTH>Amount (isi)</LabelTH></Th> */}
                            {/* <Th className="tabkeHeader"><LabelTH>Expired Date</LabelTH></Th> */}
